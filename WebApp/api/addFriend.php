...
function returnInvalid($error) {
	...
	$result["error"] = $error;
	if($error == 1)
		$result["error_msg"] = "Friendship request is already sent";
	if($error == 2)
...
if($row = mysqli_fetch_array($result)) {
	...
	// create Friendship
	$sql = "INSERT INTO friendship (user_id, friend_id, is_active) VALUES ('$user_id', '$friend_id', 0)";
